...
#this is running on a local environment; if they wanted to have an app accessible to others, you need a cloud environment (i.e streamlit cloud)

import streamlit as st #importing library streamlit and renaming it to st, a standard python convention 
import json #deals with JSON formats - converting arbitrary data structures to string and back 
...
#you can define the classes in alphabetical order
PREDICTED_LABELS = {'Healthy': 'Plant is healthy!', 'Powdery':'Plant is a bit powdery.', 'Rust':'Plant is rusty.'} #categories -> what's on screen in the app 
...
st.title("Plant Disease Recognizer/Classifier") 
...
if image:
    ...
    payload = base64.b64encode(byte_im) #take image and convert it to base64 encoded ASCII
